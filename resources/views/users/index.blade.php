      ...
      <div class="row">
          ...
          <div class="row">
            <button data-bs-toggle="modal" data-bs-target="#exampleModal">
              <div class="col-12 card p-3">
                <img src="{{ asset('/images/baground.jpg') }}" alt="img" height="200px" class="rounded-2" />
                <p class="fs-2 fw-bold">Koi1</p>
                <p class="fs-3">Rp.90.000</p>
              </div>
            </button>
          </div>
        </div>
        <div class="col-md-2 col-6 rounded-4 mb-3">
          <div class="row">
            <button data-bs-toggle="modal" data-bs-target="#exampleModal">
              <div class="col-12 card p-3">
                <img src="{{ asset('/images/baground2.jpg') }}" alt="img" height="200px" class="rounded-2" />
                <p class="fs-2 fw-bold">Koi2</p>
                <p class="fs-3">Rp.80.000</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid pt-5 pb-3">
            <div class="row">
              <div class="col-md-7">
                <img src="{{ asset('/images/baground.jpg') }}" alt="img" height="150px" />
              </div>
              <div class="col-md-5">
                <p class="fs-3 fw-bold">Koi</p>
                <p class="fs-3">Rp.20.000</p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 text-end">
                <button type="button" class="btn btn-secondary">+Keranjang</button>
          ...
          <div class="container-fluid">
            <div class="row align-content-around">
              <div class="col-2 text-center">
                <img src="{{ asset('/images/baground.jpg') }}" alt="img" height="40px" />
              </div>
              <div class="col-6 align-self-center">
                <p class="fs-4">Koi</p>
              </div>
              <div class="col-3">
                <p class="fs-3">20.000</p>
              </div>
              <div class="col-1">
                <button type="button" class="btn-close fs-5"></button>
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <div class="container-fluid">
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <p class="fs-4 fw-bold">Rp.20.000</p>
              </div>
